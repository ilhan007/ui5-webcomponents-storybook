...
<Meta title="Docs/Advanced/Configuration" />
...
For more about assets, see the dedicated [Assets](./?path=/docs/docs-getting-started-using-assets--docs) section.
...
Calendar types are opt-in features, see [Using Features](./?path=/docs/docs-getting-started-using-features--docs) for details.
