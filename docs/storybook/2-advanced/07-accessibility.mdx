...
<Meta title="Docs/Advanced/Accessibility" />
...
For more information regarding the available themes and how to use them, see the [Configuration](./?path=/docs/docs-advanced-configuration--docs) section.
