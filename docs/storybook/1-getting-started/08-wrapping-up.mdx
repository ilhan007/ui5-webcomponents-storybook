...
<Meta title="Docs/Getting started/Wrapping up" />
...
If you created the test app, described in [Getting Started](./?path=/docs/docs-getting-started-readme--docs), you can enhance it as follows:
