...
<Meta title="Docs/Customizing/Theme" />
...
<b>Note:</b> `UI Theme Designer` is not an open-source tool and requires SAP BTP account and configuration in the SAP BTP Cockpit. In case you don't have access to the UI Theme Designer - follow the [Manually Building Custom Theme](./?path=/docs/docs-customizing-theme_part2--docs) article.
...
For more on configuring themes, see [Configuration](./?path=/docs/docs-advanced-configuration--docs).
