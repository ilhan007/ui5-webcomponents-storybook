...
<Meta title="Docs/Development/Deep dive and best practices" />
...
Before you proceed, please make sure you've read the other articles from this section, especially
 - [Developing Custom UI5 Web Components](./?path=/docs/docs-development-custom-ui5-web-components--docs)
 - [Understanding UI5 Web Components Metadata](./?path=/docs/docs-development-understanding-components-metadata--docs)
 - [Understanding the Handlebars (`.hbs`) templates](./?path=/docs/docs-development-understanding-hbs-templates--docs)
...
See [Scoping](./?path=/docs/docs-advanced-scoping--docs) for more on using a suffix with tag names.
...
Even if a suffix for tag names is configured (as described in [Scoping](./?path=/docs/docs-advanced-scoping--docs)), the attribute with
...
The `individualSlots` slot metadata configuration setting (see [Understanding UI5 Web Components Metadata](./?path=/docs/docs-development-understanding-components-metadata--docs)) allows you to have a separate physical slot for each child belonging to a certain slot.
...
For more information on individual slots and how to render them in the `.hbs` template click [here](./?path=/docs/docs-development-understanding-hbs-templates.md#slots_individual--docs).
...
For more on the `.hbs` template syntax and event listeners click [here](./?path=/docs/docs-development-understanding-hbs-templates.md#syntax_at--docs).
...
However, if you set the [noConflict](./?path=/docs/docs-advanced-configuration.md#no_conflict--docs) configuration setting to `true`, only the **prefixed** event will be dispatched.
...
Finally, `invalidateOnChildChange` allows for more fine-granular rules when exactly children can invalidate their parents - see [Understanding UI5 Web Components Metadata](./?path=/docs/docs-development-understanding-components-metadata--docs).
