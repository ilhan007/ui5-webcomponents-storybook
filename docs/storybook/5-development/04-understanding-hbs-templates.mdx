...
<Meta title="Docs/Development/Understanding hbs templates" />
...
You should render each slot, defined in your component's metadata (see [Understanding UI5 Web Components Metadata](./?path=/docs/docs-development-understanding-components-metadata--docs)), somewhere in the `.hbs` template.
